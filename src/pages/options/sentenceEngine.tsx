...
export default function SentenceEngine() {
  ...
  const handleEngineChange = (engineItem: EngineItem, checked: boolean) => {
    ...
    setSetting({ sentenceEngineList: newList });
  };
  ...
  return (
    <div>
      <div className="font-semibold text-[17px] mb-3">
        {t("Translation Services for Sentences")}
      </div>
          ...
          <div className="mt-4">
            <div className="flex items-center">
              ...
              <InfoAndReset
                ...
                onReset={() =>
                  setSetting({
                    sentenceSystemPrompt: defaultSetting.sentenceSystemPrompt
                  })
                }
              />
            </div>
            ...
            <div className="flex items-center">
              ...
              <InfoAndReset
                ...
                onReset={() =>
                  setSetting({
                    sentenceUserContent: defaultSetting.sentenceUserContent
                  })
                }
              />
            </div>
